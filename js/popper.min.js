...
function l(e) {
    const t = e && e.offsetParent,
        o = t && t.nodeName;
    return o && 'BODY' !== o && 'HTML' !== o ? -1 !== ['TD', 'TABLE'].indexOf(t.nodeName) && 'static' === s(t, 'position') ? l(t) : t : e ? e.ownerDocument.documentElement : document.documentElement
}
...
function E(e, t, o, n) {
    return Math.max(t[`offset${e}`], t[`scroll${e}`], o[`client${e}`], o[`offset${e}`], o[`scroll${e}`], y() ? o[`offset${e}`] + n[`margin${'Height'===e?'Top':'Left'}`] + n[`margin${'Height'===e?'Bottom':'Right'}`] : 0)
}
...
function S(e, t) {
    ...
    if (m.marginTop = 0, m.marginLeft = 0, !o && n) {
        ...
        m.top -= a - e, m.bottom -= a - e, m.left -= l - t, m.right -= l - t, m.marginTop = e, m.marginLeft = t
    }
    return (o ? t.contains(p) : t === p && 'BODY' !== p.nodeName) && (m = g(m, t)), m
}
...
function D(e) {
    const t = e.nodeName;
    return 'BODY' === t || 'HTML' === t ? !1 : !('fixed' !== s(e, 'position')) || D(a(e))
}
...
function N(e, t, o, n) {
    ...
    if ('viewport' === n) i = T(r);
        ...
        let o;
        'scrollParent' === n ? (o = f(a(t)), 'BODY' === o.nodeName && (o = e.ownerDocument.documentElement)) : 'window' === n ? o = e.ownerDocument.documentElement : o = n;
        const p = S(o, r);
        if ('HTML' === o.nodeName && !D(r)) {
            ...
            i.top += p.top - p.marginTop, i.bottom = e + p.top, i.left += p.left - p.marginLeft, i.right = t + p.left
        } else i = p
    }
...
function M(e, t, o) {
    ...
    return n.forEach((e) => {
        ...
        e.enabled && d(o) && (t.offsets.popper = x(t.offsets.popper), t.offsets.reference = x(t.offsets.reference), t = o(t, e))
    }), t
}
...
function R() {
    ...
    e.offsets.reference = W(this.state, this.popper, this.reference), e.placement = B(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.offsets.popper = k(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = 'absolute', e = M(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
}
...
function K(e, t, o, n) {
    ...
    r.addEventListener(t, o, {
        passive: !0
    }), i || K(f(r.parentNode), t, o, n), n.push(r)
}

function V(e, t, o, n) {
    o.updateBound = n, j(e).addEventListener('resize', o.updateBound, {
        passive: !0
    });
    const i = f(e);
    return K(i, 'scroll', o.updateBound, o.scrollParents), o.scrollElement = i, o.eventsEnabled = !0, o
}
...
function z(e, t) {
    return j(e).removeEventListener('resize', t.updateBound), t.scrollParents.forEach((e) => {
...
function X(e, t) {
    Object.keys(t).forEach((o) => {
        let n = ''; - 1 !== ['width', 'height', 'top', 'right', 'bottom', 'left'].indexOf(o) && _(t[o]) && (n = 'px'), e.style[o] = t[o] + n
    })
}
...
function Z(e) {
    return X(e.instance.popper, e.styles), J(e.instance.popper, e.attributes), e.arrowElement && Object.keys(e.arrowStyles).length && X(e.arrowElement, e.arrowStyles), e
}

function $(e, t, o, n, i) {
    const r = W(i, t, e),
        p = B(o.placement, r, t, e, o.modifiers.flip.boundariesElement, o.modifiers.flip.padding);
    return t.setAttribute('x-placement', p), X(t, {
        position: 'absolute'
    }), o
}
...
function Q(e, t) {
    ...
    const {
        ...
        popper: r
    } = e.offsets, p = A(e.instance.modifiers, (e) => 'applyStyle' === e.name).gpuAcceleration;
    ...
    const d = void 0 === p ? t.gpuAcceleration : p,
        ...
        u = Y('transform');
    let g, b;
    if (b = 'bottom' == h ? -a.height + m.bottom : m.top, g = 'right' == c ? -a.width + m.right : m.left, d && u) f[u] = `translate3d(${g}px, ${b}px, 0)`, f[h] = 0, f[c] = 0, f.willChange = 'transform';
    else {
    ...
    return e.attributes = O({}, w, e.attributes), e.styles = O({}, f, e.styles), e.arrowStyles = O({}, e.offsets.arrow, e.arrowStyles), e
}
...
function te(e, t) {
    ...
    const n = e.placement.split('-')[0],
        ...
        m = p ? 'bottom' : 'right',
        h = H(o)[d];
    r[m] - h < i[f] && (e.offsets.popper[f] -= i[f] - (r[m] - h)), r[f] + h > i[m] && (e.offsets.popper[f] += r[f] + h - i[m]), e.offsets.popper = x(e.offsets.popper);
...
function de(e, t) {
    ...
    return p.forEach((d, s) => {
        ...
        const a = e.offsets.popper,
            ...
            l = Math.floor,
            m = 'left' === n && l(a.right) > l(f.left) || 'right' === n && l(a.left) < l(f.right) || 'top' === n && l(a.bottom) > l(f.top) || 'bottom' === n && l(a.top) < l(f.bottom),
            h = l(a.left) < l(o.left),
        ...
        (m || b || y) && (e.flipped = !0, (m || b) && (n = p[s + 1]), y && (r = oe(r)), e.placement = n + (r ? '-' + r : ''), e.offsets.popper = O({}, e.offsets.popper, k(e.instance.popper, e.offsets.reference, e.placement)), e = M(e.instance.modifiers, e, 'flip'))
    }), e
}
...
function fe(e, t, o, n) {
    ...
    const s = /\s*,\s*|\s+/;
    let a = -1 === d ? [p] : [p.slice(0, d).concat([p[d].split(s)[0]]), [p[d].split(s)[1]].concat(p.slice(d + 1))];
    return a = a.map((e, n) => {
        const i = (1 === n ? !r : r) ? 'height' : 'width';
        let p = !1;
        return e.reduce((e, t) => '' === e[e.length - 1] && -1 !== ['+', '-'].indexOf(t) ? (e[e.length - 1] = t, p = !0, e) : p ? (e[e.length - 1] += t, p = !1, e) : e.concat(t), []).map((e) => ae(e, i, t, o))
    }), a.forEach((e, t) => {
        e.forEach((o, n) => {
            _(o) && (i[t] += o * ('-' === e[n - 1] ? -1 : 1))
        })
...
function le(e, {
    ...
    let p;
    return p = _(+t) ? [+t, 0] : fe(t, n, i, r), 'left' === r ? (n.top += p[0], n.left -= p[1]) : 'right' === r ? (n.top += p[0], n.left += p[1]) : 'top' === r ? (n.left += p[0], n.top -= p[1]) : 'bottom' === r && (n.left += p[0], n.top += p[1]), e.popper = n, e
}
...
function me(e, t) {
    ...
    const p = {
        primary(e) {
            let o = r[e];
            return r[e] < n[e] && !t.escapeWithReference && (o = Math.max(r[e], n[e])), {
                [e]: o
            }
        },
        secondary(e) {
            ...
            let i = r[o];
            return r[e] > n[e] && !t.escapeWithReference && (i = Math.min(r[o], n[e] - ('right' === e ? r.width : r.height))), {
                [o]: i
            }
        }
    };
...
function ue(e) {
    ...
    return n[r ? 'left' : 'top'] = i[o] - (p ? n[r ? 'width' : 'height'] : 0), e.placement = P(t), e.offsets.popper = x(n), e
}
var ge = {
        shift: {
            order: 100,
...
class we {
    constructor(e, t, o = {}) {
        this.scheduleUpdate = () => requestAnimationFrame(this.update), this.update = p(this.update.bind(this)), this.options = O({}, we.Defaults, o), this.state = {
            isDestroyed: !1,
            isCreated: !1,
            scrollParents: []
        }, this.reference = e && e.jquery ? e[0] : e, this.popper = t && t.jquery ? t[0] : t, this.options.modifiers = {}, Object.keys(O({}, we.Defaults.modifiers, o.modifiers)).forEach((e) => {
            this.options.modifiers[e] = O({}, we.Defaults.modifiers[e] || {}, o.modifiers ? o.modifiers[e] : {})
...
we.Utils = ('undefined' == typeof window ? global : window).PopperUtils, we.placements = ne, we.Defaults = be;
export default we;
